...
export function UserLoginForm() {
  const [isLoading, setIsLoading] = useState<'twitter' | 'github' | null>(null)
  ...
  const handleTwitterLogin = async () => {
    try {
      ...
      toast({
        ...
        description: 'Please complete the authentication process on Twitter.',
      })
      ...
      toast({
        variant: 'destructive',
        title: 'Error',
        description: error instanceof Error ? error.message : 'Failed to login with Twitter',
      })
    } finally {
      setIsLoading(null)
    }
  ...
  const handleGitHubLogin = async () => {
    try {
      ...
      toast({
        ...
        description: 'Please complete the authentication process on GitHub.',
      })
